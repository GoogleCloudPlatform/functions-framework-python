...
"""Async function used in Worker tests of function execution time."""
import asyncio


async def function(request):
    """Async test function which sleeps for the given number of seconds.
    ...
    sleep_sec = int(payload.get("mode")) / 1000.0
